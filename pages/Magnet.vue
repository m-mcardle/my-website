  ...
  data () {
    return {
      content: [
        {
          title: 'Welcome!',
          body: 'My name is Matthew McArdle and I am a Software Engineering Student at the University of Guelph. On this page I will be going into great detail about my first co-op placement during my time at the amazing Waterloo company Magnet Forensics.\nI hope by the end of this you get a good idea about all the awesome experiences I had during my time at Magnet, and are as blown away as I am about how many different things I had the opportunity to learn.',
        ...
        },
        {
          ...
          images: [require('assets/images/Magnet/Office.jpeg')] // Picture of office
        },
        {
          title: 'AXIOM',
          ...
          images: [require('assets/images/Magnet/Axiom.png')] // Picture of AXIOM
        },
        {
          title: 'MDIS',
          ...
          images: [require('assets/images/Magnet/Automate.png'), require('assets/images/Magnet/Review.png'), require('assets/images/Magnet/Review.png')] // Picture of MDIS products
        },
        {
          ...
          images: [require('assets/images/Magnet/Nashvile.jpeg'), require('assets/images/Magnet/Scotland.png')] // Picture of Nashville and Scotland
        },
        {
        ...
        },
        {
          ...
          images: [''] // Jenkins and Azure logos require('assets/images/Magnet-Logo.png')
        },
        {
        ...
        },
        {
          ...
          images: [require('assets/images/Magnet/Refactor.png')] // refactoring logo require('assets/images/Magnet-Logo.png')
        }
      ]
    }
  }
